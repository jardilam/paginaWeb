            ...
            <ul class="navbar-nav ms-auto my-2 my-lg-0">
              ...
              <li class="nav-item">
                <b-link v-b-modal.modalLogin class="nav-link"
                 v-if="!estaActivo">Iniciar sesion</b-link
                >
                <b-link @click="cerrarSesion()" class="nav-link"
                  v-if="estaActivo">Cerrar sesion</b-link
                >
              </li>
            </ul>
          </ul>
      ...
      <div class="card text-center">
        <div class="card-body">
          <form @submit.prevent="login()">
            <div class="mb-3">
              <label for="correo" class="form-label">Correo electronico:</label>
              <input type="email" class="form-control" id="correoForm" v-model="usuario.email" />
            </div>
            <div class="mb-3">
